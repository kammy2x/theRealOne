...
def themBoys(): 
    global xCoord, yCoord, xCoord2, xCoord3, xCoord4, xCoord5, xCoord6, xCoord7, xSpeed, xSpeed2, xSpeed3, xSpeed4, xSpeed5, xSpeed6, xSpeed7  
    ...
    xCoord7 += xSpeed7 
    if xCoord7 +28 >= 320  or xCoord7 <= 280: 
        xSpeed7 = -xSpeed7
